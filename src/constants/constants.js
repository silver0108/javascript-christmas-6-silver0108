...
export const OUTPUT_MESSAGE = {
  printIntroduceMessage: "안녕하세요! 우테코 식당 12월 이벤트 플래너입니다.",
  printReceiptMessage: "12월 3일에 우테코 식당에서 받을 혜택 미리 보기!",
  printOrderMenuMessage: "\n<주문 메뉴>",
  printOrderMenu: (menu, cnt) => `${menu} ${cnt}개`,
  printTotalAmountTitle: "\n<할인 전 총주문 금액>",
  printGiftMenuTitle: "\n<증정 메뉴>",
  printBenefitDetailsTitle: "\n<혜택 내역>",
  printBenefitAmountTitle: "\n<총혜택 금액>",
  printDiscountAmountTitle: "\n<할인 후 예상 결제 금액>",
...
export const BENEFITS = [ "크리스마스 디데이 할인", "평일 할인", "주말 할인", "특별 할인", "증정 이벤트"]
